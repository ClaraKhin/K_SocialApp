    ...
    >
      <div className="text-center">
        <img
          ...
          alt=""
          className="rounded-full w-16 h-16 shadow-md mx-auto object-cover object-top cursor-pointer"
      ...
      <div className="flex mt-4 gap-2">
        ...
        <button
          ...
          className="flex items-center justify-center w-16 border text-slate-500 group rounded-md cursor-pointer active:scale-95 transiton"
        >
