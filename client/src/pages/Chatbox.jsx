...
const Chatbox = () => {
  ...
  const sendMessage = () => {
    if (!text && !image) {
      toast.error("Please enter some text or image");
      return;
    }
    ...
    setTimeout(() => {
      //scroll to bottom of chatbox after 1 second
  ...
  useEffect(() => {
    messagesEndRef.current?.scrollIntoView({ behavior: "smooth" });
  }, [messages]); //scroll to bottom of chatbox when new message is added

  return (
    user && (
      <div className="flex flex-col h-screen">
        <div className="flex items-center gap-2 p-2 md:px-10 xl:pl-42 bg-white border-b border-gray-300 ">
          <img
