              ...
              >
                ...
                <div className="relative group/profile">
                  <img
                    ...
                    alt=""
                    className="w-24 h-24 rounded-full object-cover object-top mt-2"
                  />
                  <div className="absolute hidden group-hover/profile:flex top-0 right-0 bottom-0 left-0 bg-black/20 rounded-full items-center justify-center">
