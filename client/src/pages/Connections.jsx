                ...
                <div className="flex-1">
                  ...
                  <div className="flex max-sm:flex-col gap-2 mt-4">
                    ...
                    {currentTab === "following" && (
                      <button className="w-full p-2 text-sm rounded bg-[#d6e6f2] hover:bg-[#b9d7ea] text-black active:scale-95 transition cursor-pointer">
                        Unfollow
                      </button>
                    )}
                    {currentTab === "pending" && (
                    ...
                    {currentTab === "connections" && (
                      <button
                        ...
                        className="w-full p-2 text-sm rounded  bg-[#d6e6f2] hover:bg-[#b9d7ea] active:scale-95 transition cursor-pointer flex items-center justify-center gap-1"
                      >
